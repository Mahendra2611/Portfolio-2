...
const Card = () => { "/assets/profile_pic.jpg"
  return (
    <div className="mb-16">
...
/>
  ...
  className="flex justify-center items-center gap-1 p-2 bg-gradient-to-t from-blue-600 to-gray-300 text-xs font-medium text-gray-300 rounded-lg shadow-inner"
>
